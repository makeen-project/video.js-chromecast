...
class ChromeCastButton extends Button {
  ...
  constructor(player, options) {
    ...
    options.customData = player.options_.chromecast.customData;
  ...
  onSessionSuccess(session) {
    ...
    if (this.options_.customData) {
      ref = this.options_.customData;
  ...
  onStopAppSuccess() {
    ...
    this.player_.trigger('seeked', {data: { continuePlaying: true }});
    return this.apiSession = null;

    // let time = this.player_.currentTime();
    // const paused = this.player_.paused();
    // this.player_.loadTech_(this.oldTech_,this.oldSrc_);
    // this.removeClass('connected');
    // this.player_.src(this.player_.options_['sources']);
    //
    // if (!paused) {
    //   // this.player_.on('seeked', function () {
    ...
    // this.player_.currentTime(time);
    // this.player_.options_.inactivityTimeout = this.inactivityTimeout;
    // !paused ? this.player_.play() : this.player_.trigger('seeked');
    //
    // return this.apiSession = null;
  }
